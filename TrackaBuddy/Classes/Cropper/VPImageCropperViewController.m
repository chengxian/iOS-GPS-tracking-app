...
- (id)initWithImage:(UIImage *)originalImage cropFrame:(CGRect)cropFrame limitScaleRatio:(NSInteger)limitRatio {
    ...
    if (self) {
        ...
        self.cropFrame = CGRectMake(10, 140, width, width);
...
- (void)initView
{
    ...
    //self.cropFrame
    self.ratioView = [[UIView alloc] initWithFrame:CGRectMake(10, 140, self.cropFrame.size.width, self.cropFrame.size.height)];
    NSLog(@"width : %.2f, height : %.2f", self.cropFrame.size.width, self.cropFrame.size.height);
    ...
    label.text = @"Crop";
    [label sizeToFit];
    label.frame = CGRectMake(([UserDataSingleton sharedSingleton].screenWidth - 133) / 2, 26, 133, 24);
    [self.view addSubview:label];
    
    UIButton *aButton = [UIButton buttonWithType:UIButtonTypeCustom];
    aButton.frame = CGRectMake(8, 26, 60, 24);
    ...
    aButton1.frame = CGRectMake([UserDataSingleton sharedSingleton].screenWidth - 60 - 8, 26, 60, 24);
    [aButton1.titleLabel setFont:[UIFont systemFontOfSize:17]];
